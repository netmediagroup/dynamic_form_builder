class CreateDynamicArrayGroups < ActiveRecord::Migration
  def self.up
    create_table :dynamic_array_groups do |t|
      ...
      t.integer :dynamic_arrayable_id, :dynamic_array_id, :null => false
      t.integer :sort, :null => false, :default => 0
    end
    add_index :dynamic_array_groups, [:dynamic_arrayable_type, :dynamic_arrayable_id], :name => 'index_dag_on_dynamic_arrayable'
